...
## 1.7 Spring Boot Dev Tools
    - If we add the devtools dependency to pom automatically it will restart if we do any changes
    - we need to enable it in Intellij after adding in the pom file 
